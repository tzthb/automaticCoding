...
model.add(Dropout(0.4))
model.add(Dense(4, activation='linear', kernel_regularizer=l1_l2_regularizer))
...
run["eval/confusion_matrix"].upload('confusion_matrix1.png')

# Save the model
model.save('lstm_multilabel_model2.h5')
...
model_version["model"].upload('./lstm_multilabel_model2.h5')
