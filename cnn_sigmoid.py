...
model_cnn.add(Conv1D(512, 3, activation='relu'))
model_cnn.add(MaxPooling1D(pool_size=2))
# Second Conv1D layer with 512 filters
model_cnn.add(Conv1D(512, 3, activation='tanh'))
model_cnn.add(MaxPooling1D(pool_size=2))
...
model_cnn.add(Conv1D(512, 3, activation='relu'))
model_cnn.add(MaxPooling1D(pool_size=2))
# Fifth Conv1D layer with 512 filters
model_cnn.add(Conv1D(512, 3, activation='relu'))
model_cnn.add(MaxPooling1D(pool_size=2))
...
model_cnn.fit(X_train, y_train, validation_data=(X_val, y_val), epochs=10, batch_size=256, callbacks=[early_stopping])
...
plt.show()
#save heatmap
plt.savefig('heatmap_cnnsigmoid.png')
